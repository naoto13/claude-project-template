...
複雑な言葉や大げさな言葉を平易な英語の代替語に置き換える。

出典：Plain English Campaign A-Z of Alternative Words（2001年）、Australian Government Style Manual（2024年）、plainlanguage.gov
...
- basically
- currently（「now」や何もない方がよい場合）
- I am of the opinion that（代わりに：I think）
- in due course（代わりに：soon、または具体的な時期を述べる）
