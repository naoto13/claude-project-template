...
| `anthropic-skills` | `https://docs.anthropic.com/en/docs/claude-code/skills` | official_doc | special-skill-creator, check-claude-md |
| `anthropic-sub-agents` | `https://docs.anthropic.com/en/docs/claude-code/sub-agents` | official_doc | special-skill-creator |
